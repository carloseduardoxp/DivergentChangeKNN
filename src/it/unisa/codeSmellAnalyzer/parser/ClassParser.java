...
public class ClassParser {
	...
	public static ClassBean parse(TypeDeclaration pClassNode) {
		...
		for (Object interfaceName: pClassNode.superInterfaceTypes()) {
			interfaces.add(interfaceName.toString());
		}
		classBean.setInterfaces(interfaces);
	
		if (pClassNode.isInterface()) {
			classBean.setTipo("Interface");
		} else {
			classBean.setTipo("Classe");
		}
		// Set the name
